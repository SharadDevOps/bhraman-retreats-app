  ...
  return (
    <div className="hero-content">
      ...
      <div className="hero-actions" aria-label="Hero actions">
        <PrimaryButton href={HERO_CTAS.primary.href} aria-label={HERO_CTAS.primary.label} onClick={() => trackAnonymousProductEvent("retreat_cta_clicked", { source: "hero" })} onDark>{HERO_CTAS.primary.label}</PrimaryButton>
