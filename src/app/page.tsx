...
export default async function Home() {
  ...
  return <main id="top">
    ...
    <section className="founder-section" id="founder"><Fireflies /><div className="founder-copy"><Sparkles size={28} /><p className="eyebrow light">Meet your guide</p><h2>Rooted in medicine.<br /><em>Guided by nature.</em></h2><blockquote>“Nature holds everything we need to heal. We only have to learn how to listen again.”</blockquote><p>Dr. Pratiksha Shekhawat · Doctor, yoga and elemental therapist</p><a className="text-link light" href="#booking">Begin your journey <ArrowRight size={17} /></a></div><div className="founder-image">{media.founder ? <img className="slot-img" src={media.founder} alt="Dr. Pratiksha Shekhawat" /> : <span className="image-placeholder">Founder portrait<br /><small>Manage from admin</small></span>}</div></section>
